...
import json
import spacy #named entity
import spacy_streamlit #visualizers for syntactic dependencies, named entities, text classification, ...
...
def main():
    ...
    if choice=="--Select--":
        ...
        if raw_text!="" and num_words is not None:
            ...
            s1 = json.dumps(summary[0])#loads() takes in a string and returns a json object. json. dumps() takes in a json object and returns a string
            d2 = json.loads(s1) #allows writing tabular data in a JSON file
